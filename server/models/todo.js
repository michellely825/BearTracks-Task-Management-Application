...
const todoSchema = new mongoose.Schema({
  ...
  user: { type: mongoose.Schema.Types.ObjectId, ref: "User", required: true }, // stores reference as an ObjectId which allows populate() to know which collection to look into
});
